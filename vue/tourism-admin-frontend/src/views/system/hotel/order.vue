      ...
      <div class="search-table">
        ...
        <div class="table">
            ...
            <el-table-column
              ...
              >
              <template slot-scope="scope">
                <el-button size="mini" type="warning" @click="editSysHotelOrder(scope.row.id,5)">已使用</el-button>
                <el-button size="mini" v-if="scope.row.state == 2" type="primary" @click="editSysHotelOrder(scope.row.id,4)">不可取消</el-button>
                <el-button size="mini" v-if="scope.row.state == 2" type="primary" @click="editSysHotelOrder(scope.row.id,3)">取消</el-button>
                <el-button size="mini" v-if="scope.row.state == 0" type="primary" @click="editSysHotelOrder(scope.row.id,1)">确认</el-button>
